...
-- WHERE `menu_id`=1628, `id`=0;

-- UPDATE `locales_gossip_menu_option` SET
-- 	`option_text_loc4`='I need to know where the princess are, Kharan!'	-- I need to know where the princess are, Kharan!
-- WHERE `menu_id`=1822, `id`=0;

-- UPDATE `locales_gossip_menu_option` SET
-- 	`option_text_loc4`='Not enough, you need to tell me more.'	-- Not enough, you need to tell me more.
-- WHERE `menu_id`=1829, `id`=0;

-- UPDATE `locales_gossip_menu_option` SET
-- 	`option_text_loc4`='Gor''shak is my friend, you can trust me.'	-- Gor'shak is my friend, you can trust me.
-- WHERE `menu_id`=1830, `id`=0;

-- UPDATE `locales_gossip_menu_option` SET
-- 	`option_text_loc4`='Transcript the Tablet'	-- Transcript the Tablet
-- WHERE `menu_id`=2187, `id`=0;

-- UPDATE `locales_gossip_menu_option` SET
-- 	`option_text_loc4`='GOSSIP_OPTION_QUESTGIVER'	-- GOSSIP_OPTION_QUESTGIVER
-- WHERE `menu_id`=2744, `id`=1;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='我想看看你的货物。'	-- GOSSIP_OPTION_QUESTGIVER
WHERE `menu_id`=2890, `id`=5;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='我想得到训练。'	-- I would like to train.
WHERE `menu_id`=3067, `id`=0;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='艾瑞丹，我把上古长笛弄丢了，想再要一支。'	-- I lost the Flute of the Ancients and require a replacement, Eridan.
WHERE `menu_id`=3142, `id`=0;

-- UPDATE `locales_gossip_menu_option` SET
-- 	`option_text_loc4`='GOSSIP_OPTION_QUESTGIVER'	-- GOSSIP_OPTION_QUESTGIVER
-- WHERE `menu_id`=3624, `id`=1;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='训练我'	-- Train me
WHERE `menu_id`=3643, `id`=0;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='我想遗忘我的天赋。'	-- I wish to unlearn my talents.
WHERE `menu_id`=3984, `id`=1;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='<取信>'	-- <Take the letter>
WHERE `menu_id`=3984, `id`=4;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='我想训练。'	-- I'd like to train.
WHERE `menu_id`=4007, `id`=0;

-- UPDATE `locales_gossip_menu_option` SET
-- 	`option_text_loc4`='GOSSIP_OPTION_QUESTGIVER'	-- GOSSIP_OPTION_QUESTGIVER
-- WHERE `menu_id`=4106, `id`=1;

-- UPDATE `locales_gossip_menu_option` SET
-- 	`option_text_loc4`='GOSSIP_OPTION_QUESTGIVER'	-- GOSSIP_OPTION_QUESTGIVER
-- WHERE `menu_id`=4107, `id`=1;

-- UPDATE `locales_gossip_menu_option` SET
-- 	`option_text_loc4`='GOSSIP_OPTION_QUESTGIVER'	-- GOSSIP_OPTION_QUESTGIVER
-- WHERE `menu_id`=4281, `id`=1;

-- UPDATE `locales_gossip_menu_option` SET
-- 	`option_text_loc4`='GOSSIP_OPTION_QUESTGIVER'	-- GOSSIP_OPTION_QUESTGIVER
-- WHERE `menu_id`=4302, `id`=1;

-- UPDATE `locales_gossip_menu_option` SET
-- 	`option_text_loc4`='GOSSIP_OPTION_QUESTGIVER'	-- GOSSIP_OPTION_QUESTGIVER
-- WHERE `menu_id`=4307, `id`=1;

-- UPDATE `locales_gossip_menu_option` SET
-- 	`option_text_loc4`='GOSSIP_OPTION_QUESTGIVER'	-- GOSSIP_OPTION_QUESTGIVER
-- WHERE `menu_id`=4323, `id`=1;

-- UPDATE `locales_gossip_menu_option` SET
-- 	`option_text_loc4`='GOSSIP_OPTION_QUESTGIVER'	-- GOSSIP_OPTION_QUESTGIVER
-- WHERE `menu_id`=4342, `id`=1;

-- UPDATE `locales_gossip_menu_option` SET
-- 	`option_text_loc4`='GOSSIP_OPTION_QUESTGIVER'	-- GOSSIP_OPTION_QUESTGIVER
-- WHERE `menu_id`=4360, `id`=1;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='训练我'	-- Train me
WHERE `menu_id`=4468, `id`=0;

-- UPDATE `locales_gossip_menu_option` SET
-- 	`option_text_loc4`='GOSSIP_OPTION_QUESTGIVER'	-- GOSSIP_OPTION_QUESTGIVER
-- WHERE `menu_id`=4485, `id`=2;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='<取信>'	-- <Take the letter>
WHERE `menu_id`=4502, `id`=4;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='<取信>'	-- <Take the letter>
WHERE `menu_id`=4512, `id`=4;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='<取信>'	-- <Take the letter>
WHERE `menu_id`=4513, `id`=4;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='我需要更多牧师的训练方法。'	-- I seek more training in the priestly ways.
WHERE `menu_id`=4521, `id`=0;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='我需要更多牧师的训练方法。'	-- I seek more training in the priestly ways.
WHERE `menu_id`=4522, `id`=0;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='我需要更多牧师的训练方法。'	-- I seek more training in the priestly ways.
WHERE `menu_id`=4523, `id`=0;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='你训练我如何使用盗贼技能？'	-- an you train me how to use rogue skills?
WHERE `menu_id`=4540, `id`=0;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='<取信>'	-- <Take the letter>
WHERE `menu_id`=4540, `id`=4;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='你训练我如何使用盗贼技能？'	-- an you train me how to use rogue skills?
WHERE `menu_id`=4541, `id`=0;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='<取信>'	-- <Take the letter>
WHERE `menu_id`=4541, `id`=4;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='你训练我如何使用盗贼技能？'	-- an you train me how to use rogue skills?
WHERE `menu_id`=4542, `id`=0;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='<取信>'	-- <Take the letter>
WHERE `menu_id`=4542, `id`=4;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='我想遗忘我的天赋。'	-- I wish to unlearn my talents.
WHERE `menu_id`=4556, `id`=1;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='我想遗忘我的天赋。'	-- I wish to unlearn my talents.
WHERE `menu_id`=4557, `id`=1;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='<取信>'	-- <Take the letter>
WHERE `menu_id`=4561, `id`=4;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='<取信>'	-- <Take the letter>
WHERE `menu_id`=4562, `id`=4;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='<取信>'	-- <Take the letter>
WHERE `menu_id`=4576, `id`=4;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='我想训练。'	-- I'd like to train.
WHERE `menu_id`=4652, `id`=0;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='<取信>'	-- <Take the letter>
WHERE `menu_id`=4658, `id`=4;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='<取信>'	-- <Take the letter>
WHERE `menu_id`=4659, `id`=4;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='我需要更多牧师的训练方法。'	-- I seek more training in the priestly ways.
WHERE `menu_id`=4665, `id`=0;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='训练我'	-- Train me
WHERE `menu_id`=4666, `id`=0;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='<取信>'	-- <Take the letter>
WHERE `menu_id`=4676, `id`=4;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='训练我'	-- Train me
WHERE `menu_id`=4680, `id`=0;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='<取信>'	-- <Take the letter>
WHERE `menu_id`=4690, `id`=4;

-- UPDATE `locales_gossip_menu_option` SET
-- 	`option_text_loc4`='GOSSIP_OPTION_QUESTGIVER'	-- GOSSIP_OPTION_QUESTGIVER
-- WHERE `menu_id`=4746, `id`=1;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='我的回答──诺兹多姆。'	-- My answer - Nozdormu.
WHERE `menu_id`=4763, `id`=2;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='古尔丹'	-- Gul'dan
WHERE `menu_id`=4764, `id`=0;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='克尔苏加德'	-- Kel'Thuzad
WHERE `menu_id`=4764, `id`=1;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='我怎么才能训练我的宠物？'	-- How do I train my pet?
WHERE `menu_id`=4783, `id`=1;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='<取信>'	-- <Take the letter>
WHERE `menu_id`=5061, `id`=4;

-- UPDATE `locales_gossip_menu_option` SET
-- 	`option_text_loc4`='[PH] I desire an aqual quintessence, Duke Hydraxis.'	-- [PH] I desire an aqual quintessence, Duke Hydraxis.
-- WHERE `menu_id`=5065, `id`=0;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='弩'	-- Crossbow
WHERE `menu_id`=5222, `id`=0;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='枪'	-- Gun
WHERE `menu_id`=5222, `id`=1;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='锤'	-- Mace
WHERE `menu_id`=5222, `id`=2;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='长柄武器'	-- Polearm
WHERE `menu_id`=5222, `id`=3;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='法杖'	-- Staff
WHERE `menu_id`=5222, `id`=4;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='剑'	-- Sword
WHERE `menu_id`=5222, `id`=5;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='弩'	-- Crossbow
WHERE `menu_id`=5262, `id`=0;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='匕首'	-- Dagger
WHERE `menu_id`=5262, `id`=1;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='拳套'	-- Fist Weapon
WHERE `menu_id`=5262, `id`=2;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='枪'	-- Gun
WHERE `menu_id`=5262, `id`=3;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='锤'	-- Mace
WHERE `menu_id`=5262, `id`=4;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='长柄武器'	-- Polearm
WHERE `menu_id`=5262, `id`=5;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='剑'	-- Sword
WHERE `menu_id`=5262, `id`=6;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='斧'	-- Axe
WHERE `menu_id`=5265, `id`=0;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='弓'	-- Bow
WHERE `menu_id`=5265, `id`=1;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='弩'	-- Crossbow
WHERE `menu_id`=5265, `id`=2;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='匕首'	-- Dagger
WHERE `menu_id`=5265, `id`=3;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='拳套'	-- Fist Weapon
WHERE `menu_id`=5265, `id`=4;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='长柄武器'	-- Polearm
WHERE `menu_id`=5265, `id`=5;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='剑'	-- Sword
WHERE `menu_id`=5265, `id`=6;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='投掷武器'	-- Thrown
WHERE `menu_id`=5265, `id`=7;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='斧'	-- Axe
WHERE `menu_id`=5268, `id`=0;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='弓'	-- Bow
WHERE `menu_id`=5268, `id`=1;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='拳套'	-- Fist Weapon
WHERE `menu_id`=5268, `id`=2;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='枪'	-- Gun
WHERE `menu_id`=5268, `id`=3;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='锤'	-- Mace
WHERE `menu_id`=5268, `id`=4;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='法杖'	-- Staff
WHERE `menu_id`=5268, `id`=5;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='投掷武器'	-- Thrown
WHERE `menu_id`=5268, `id`=6;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='斧'	-- Axe
WHERE `menu_id`=5270, `id`=0;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='弓'	-- Bow
WHERE `menu_id`=5270, `id`=1;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='拳套'	-- Fist Weapon
WHERE `menu_id`=5270, `id`=2;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='枪'	-- Gun
WHERE `menu_id`=5270, `id`=3;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='锤'	-- Mace
WHERE `menu_id`=5270, `id`=4;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='投掷武器'	-- Thrown
WHERE `menu_id`=5270, `id`=5;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='斧'	-- Axe
WHERE `menu_id`=5272, `id`=0;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='弩'	-- Crossbow
WHERE `menu_id`=5272, `id`=1;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='枪'	-- Gun
WHERE `menu_id`=5272, `id`=2;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='锤'	-- Mace
WHERE `menu_id`=5272, `id`=3;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='长柄武器'	-- Polearm
WHERE `menu_id`=5272, `id`=4;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='剑'	-- Sword
WHERE `menu_id`=5272, `id`=5;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='弓'	-- Bow
WHERE `menu_id`=5274, `id`=0;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='弩'	-- Crossbow
WHERE `menu_id`=5274, `id`=1;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='匕首'	-- Dagger
WHERE `menu_id`=5274, `id`=2;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='长柄武器'	-- Polearm
WHERE `menu_id`=5274, `id`=3;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='投掷武器'	-- Thrown
WHERE `menu_id`=5274, `id`=4;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='法杖'	-- Staff
WHERE `menu_id`=5274, `id`=5;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='剑'	-- Sword
WHERE `menu_id`=5274, `id`=6;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='斧'	-- Axe
WHERE `menu_id`=5276, `id`=0;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='弓'	-- Bow
WHERE `menu_id`=5276, `id`=1;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='拳套'	-- Fist Weapon
WHERE `menu_id`=5276, `id`=2;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='枪'	-- Gun
WHERE `menu_id`=5276, `id`=3;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='锤'	-- Mace
WHERE `menu_id`=5276, `id`=4;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='长柄武器'	-- Polearm
WHERE `menu_id`=5276, `id`=5;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='法杖'	-- Staff
WHERE `menu_id`=5276, `id`=6;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='剑'	-- Sword
WHERE `menu_id`=5276, `id`=7;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='我想把宠物寄养在这里。'	-- I'd like to stable my pet here.
WHERE `menu_id`=5283, `id`=1;

-- UPDATE `locales_gossip_menu_option` SET
-- 	`option_text_loc4`='Please teach me how to make a Gordok Ogre Suit!'	-- Please teach me how to make a Gordok Ogre Suit!
-- WHERE `menu_id`=5667, `id`=2;

-- UPDATE `locales_gossip_menu_option` SET
-- 	`option_text_loc4`='Please teach me how to make a Gordok Ogre Suit!'	-- Please teach me how to make a Gordok Ogre Suit!
-- WHERE `menu_id`=5667, `id`=3;

-- UPDATE `locales_gossip_menu_option` SET
-- 	`option_text_loc4`='GOSSIP_OPTION_QUESTGIVER'	-- GOSSIP_OPTION_QUESTGIVER
-- WHERE `menu_id`=5853, `id`=1;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='<把你的手放在球上。>'	-- <Put your hand on the sphere.>
WHERE `menu_id`=6001, `id`=0;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='我不能，瓦拉斯塔兹！肯定有办法治愈你！'	-- I can not Vaelastrasz ! Surely there must be some way to heal you!
WHERE `menu_id`=6021, `id`=0;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='我想把宠物寄养在这里。'	-- I'd like to stable my pet here
WHERE `menu_id`=6088, `id`=1;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='你说暗月马戏团来了？她现在在哪里？'	-- The Darkmoon Faire has arrived, you say? And where is she now?
WHERE `menu_id`=6213, `id`=0;

-- UPDATE `locales_gossip_menu_option` SET
-- 	`option_text_loc4`='[ph]Learn recipe...'	-- [ph]Learn recipe...
-- WHERE `menu_id`=6443, `id`=0;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='赤红圣殿骑士！我持有你的印记！听从我的呼唤！'	-- Crimson Templar! I hold your signet! Heed my call!
WHERE `menu_id`=6540, `id`=1;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='土色圣殿骑士！我持有你的印记！听从我的呼唤！'	-- Earthen Templar! I hold your signet! Heed my call!
WHERE `menu_id`=6540, `id`=2;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='苍白圣殿骑士！我持有你的印记！听从我的呼唤！'	-- Hoary Templar! I hold your signet! Heed my call!
WHERE `menu_id`=6540, `id`=3;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='碧蓝圣殿骑士！我持有你的印记！听从我的呼唤！'	-- Azure Templar! I hold your signet! Heed my call!
WHERE `menu_id`=6540, `id`=4;
...
-- WHERE `menu_id`=6565, `id`=2;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='<更多>'	-- <more>
WHERE `menu_id`=6579, `id`=0;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='兑换战场荣誉奖章。'	-- Redeem Battleground Marks for Honor.
WHERE `menu_id`=6597, `id`=0;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='兑换战场荣誉奖章。'	-- Redeem Battleground Marks for Honor.
WHERE `menu_id`=6598, `id`=0;

-- UPDATE `locales_gossip_menu_option` SET
-- 	`option_text_loc4`='May I have your report?'	-- May I have your report?
-- WHERE `menu_id`=6690, `id`=0;

-- UPDATE `locales_gossip_menu_option` SET
-- 	`option_text_loc4`='May I have your report?'	-- May I have your report?
-- WHERE `menu_id`=6691, `id`=0;

-- UPDATE `locales_gossip_menu_option` SET
-- 	`option_text_loc4`='May I have your report?'	-- May I have your report?
-- WHERE `menu_id`=6692, `id`=0;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='我想把宠物寄养在这里。'	-- I'd like to stable my pet here
WHERE `menu_id`=6791, `id`=0;

-- UPDATE `locales_gossip_menu_option` SET
-- 	`option_text_loc4`=' Decipher the pattern and learn its content.'	--  Decipher the pattern and learn its content.
-- WHERE `menu_id`=6799, `id`=0;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='麦蹄长者在哪里？'	-- Where is Elder Ezra Wheathoof?
WHERE `menu_id`=6814, `id`=3;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='麦蹄长者在哪里？'	-- Where is Elder Ezra Wheathoof?
WHERE `menu_id`=6828, `id`=6;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='麦蹄长者在哪里？'	-- Where is Elder Ezra Wheathoof?
WHERE `menu_id`=6832, `id`=5;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='麦蹄长者在哪里？'	-- Where is Elder Ezra Wheathoof?
WHERE `menu_id`=6899, `id`=3;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='祝你好运。'	-- Good luck.
WHERE `menu_id`=6924, `id`=1;

-- UPDATE `locales_gossip_menu_option` SET
-- 	`option_text_loc4`='GOSSIP_OPTION_QUESTGIVER'	-- GOSSIP_OPTION_QUESTGIVER
-- WHERE `menu_id`=6944, `id`=1;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='zzOLDSnake Trap (NEW)'	-- Lexicon of Power
WHERE `menu_id`=6957, `id`=13;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='zzOLDSnake Trap (NEW)'	-- Lexicon of Power
WHERE `menu_id`=6958, `id`=13;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='zzOLDSnake Trap (NEW)'	-- Lexicon of Power
WHERE `menu_id`=6999, `id`=12;

UPDATE `locales_gossip_menu_option` SET
	`option_text_loc4`='zzOLDSnake Trap (NEW)'	-- Lexicon of Power
WHERE `menu_id`=7035, `id`=14;
